...
The following pilot results were obtained between January 29, 2017 and March 4, 2017.
...
weekly_levels %>%
    ...
    theme(axis.ticks = element_blank(), axis.line = element_blank(), panel.grid.major.x = element_blank(), panel.border = element_blank())
```
