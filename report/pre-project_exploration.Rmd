...
Percent of levels ordered but never drawn: `r round((nrow(not_drawn) - sum(!is.na(not_drawn$collect_detail_diff))) / nrow(not_drawn) * 100, 2)`%  
...
```{r}
t.test(collect_detail_diff ~ shift, not_drawn)
```
